...
PROMPT='$user_status on %{$fg[blue]%}%m%{$fg[cyan]%}[$(uname -s)]%(#.%{$fg_bold[yellow]%}.%{$fg_bold[white]%}) ओम् %{$reset_color%}%{$fg[cyan]%}%~:%{$reset_color%}$(git_time_since_commit)$(git_prompt_info)
